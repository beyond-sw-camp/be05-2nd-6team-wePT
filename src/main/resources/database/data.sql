...
VALUES
    ...
    ('mia_wong', 'passwordabc', 'MiaWong', 'mia@example.com', '010-7913-0123', 33, 216, true, CURRENT_TIMESTAMP, NULL, false, 18),
    ...
    ('mia_wong_2', 'passwordabc', 'MiaWong', 'mia2@example.com', '010-3627-0123', 33, 236, true, CURRENT_TIMESTAMP, NULL, false,18),
