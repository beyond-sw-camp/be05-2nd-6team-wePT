...
VALUES ('john_doe', 'password123', 'JohnDoe', 'john@example.com', '010-1234-5678', 3, 201, true, CURRENT_TIMESTAMP,
       ...
       ('james_liu', 'passworddef', 'JamesLiu', 'james@example.com', '010-0918-1234', 35, 217, true, CURRENT_TIMESTAMP,
        NULL, false, 3, 'MEMBER'),
       ('emma_zhang', 'passwordghi', 'EmmaZhang', 'emma@example.com', '010-8564-2345', 37, 218, true, CURRENT_TIMESTAMP,
        NULL, false, 4, 'MEMBER'),
       ...
       ('ethan_hall_2', 'passwordvwx', 'EthanHall', 'ethan2@example.com', '010-0826-5678', 23, 231, true,
        CURRENT_TIMESTAMP, NULL, false, 11, 'MEMBER'),
       ('emma_choi_2', 'passwordyz', 'EmmaChoi', 'emma2@example.com', '010-6657-6789', 25, 232, true, CURRENT_TIMESTAMP,
        NULL, false, 12, 'MEMBER'),
       ('liam_yang_2', 'password123', 'LiamYang', 'liam2@example.com', '010-8623-7890', 27, 233, true,
        CURRENT_TIMESTAMP, NULL, false, 13, 'MEMBER'),
       ('ava_huang_2', 'password456', 'AvaHuang', 'ava2@example.com', '010-4483-8901', 29, 234, true, CURRENT_TIMESTAMP,
        NULL, false, 14, 'MEMBER'),
       ('noah_wang_2', 'password789', 'NoahWang', 'noah2@example.com', '010-5887-9012', 31, 235, true,
        CURRENT_TIMESTAMP, NULL, false, 15, 'MEMBER'),
       ('mia_wong_2', 'passwordabc', 'MiaWong', 'mia2@example.com', '010-3627-0123', 33, 236, true, CURRENT_TIMESTAMP,
        NULL, false, 18, 'MEMBER'),
       ('james_liu_2', 'passworddef', 'JamesLiu', 'james2@example.com', '010-3169-1234', 35, 237, true,
        CURRENT_TIMESTAMP, NULL, false, 3, 'MEMBER'),
       ('emma_zhang_2', 'passwordghi', 'EmmaZhang', 'emma2@example.com', '010-2267-2345', 37, 238, true,
        CURRENT_TIMESTAMP, NULL, false, 4, 'MEMBER'),
       ('logan_chen_2', 'passwordjkl', 'LoganChen', 'logan2@example.com', '010-4775-3456', 39, 239, true,
        CURRENT_TIMESTAMP, NULL, false, 5, 'MEMBER'),
